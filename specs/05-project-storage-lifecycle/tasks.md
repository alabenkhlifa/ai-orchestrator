...
- Capability readiness: `capability:project-storage-governance` is ready after Task 6; its full focused proof and slice verification evidence are recorded below.
...
- Capability readiness: `capability:project-storage-authority` is ready after Task 4; its full focused proof and slice verification evidence are recorded below.
